...
public class DettaglioLinee {
     ...
     */
    public void setTipoCessionePrestazione(final TipoCessionePrestazione tipoCessionePrestazione) {
     ...
     * (eg CPV, EAN, TARIC ...)
     */
    public void setCodiceArticolo(final List<CodiceArticolo> codiceArticolo) {
     ...
     */
    public void setAltriDatiGestionali(final List<AltriDatiGestionali> altriDatiGestionali) {
