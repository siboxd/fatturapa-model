...
class DatiCassaPrevidenzialeTypeTest {
    ...
    void exampleDatiCassaPrevidenziale_1() {
        final DatiCassaPrevidenzialeType testDatiCassaPrevidanziale = new DatiCassaPrevidenzialeType();
        testDatiCassaPrevidanziale.setTipoCassa(TipoCassaType.TC02);
